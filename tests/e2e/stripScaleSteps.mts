...
/** What a strip's CARD is painted with: the alpha of `rgba(11,15,26,a)`, read off the real
...
function cardAlpha(page: Page): Promise<number> {
  return page.evaluate(() => {
    ...
    for (const el of Array.from(document.querySelectorAll('div'))) {
      // PALETTE.bg is #0b0f1a (the 2026-09-06 retro theme) = rgb(11, 15, 26); it was #0f1115 before.
