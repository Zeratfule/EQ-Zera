...
pub struct BuffTimersModule {
    /// Shared with `buffs`, which checkpoints it; this handle is carried over on restore.
    #[serde(skip, default = "crate::modules::buffs::empty_core")]
    core: SharedCore,
    holds: JsMap<Held>,
    ends: Vec<CcEnd>,
...
impl EqModule for BuffTimersModule {
    ...
    fn restore(&mut self, bytes: &[u8]) -> bool {
        ...
        fresh.core = SharedCore::clone(&self.core);
        *self = fresh;
        true
    }
