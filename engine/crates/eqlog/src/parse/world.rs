...
use super::acquire::{sold_price, AcquireRes};
...
impl WorldRes {
    pub fn new() -> Self {
        ...
        WorldRes {
            ...
            // `(with a bonus)` is EQ Legends' bonus-experience spelling (Z Engine, 2026-09-07: 400 of
            // the owner's 1,775 gains carried it and every one was `unknown`). Non-capturing, so the
            // percentage stays group 2.
