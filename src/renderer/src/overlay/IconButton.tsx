...
// and event windows tint the pressed state violet, the healing pair tints it green, matching each
...
export const ICON_ACCENT_VIOLET = withAlpha(PALETTE.accent, 0.2)
  ...
  return (
    <button
      ...
      style={{
        ...
        color: danger ? PALETTE.red : 'inherit',
        padding: 0
      }}
