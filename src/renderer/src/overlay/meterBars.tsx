...
/**
 * The damage meter's accent — the violet the window border and the header title already wear, and
...
// ivory, deliberately far from the melee violet: a Slay Undead proc flattens into a row named after
