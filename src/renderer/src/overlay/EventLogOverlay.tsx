...
/** Per-kind accent + glyph. Colors match the app's semantics (alerts violet — the app accent —
 *  loot cyan, quest green, consider amber — a hue none of the other three uses, so a con row is identifiable at a glance
...
const KIND_STYLE: Record<FeedEvent['kind'], { color: string; glyph: string }> = {
  alert: { color: PALETTE.accent, glyph: '!' },
  loot: { color: PALETTE.cyan, glyph: '◆' },
  quest: { color: PALETTE.green, glyph: '✦' },
  con: { color: PALETTE.amber, glyph: '◎' }
}
  ...
  return (
    <div
      ...
      style={{
        ...
        border: locked ? '1px solid rgba(255,255,255,0.04)' : `1px solid ${withAlpha(PALETTE.accent, 0.4)}`,
        borderRadius: 8,
