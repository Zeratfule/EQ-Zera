...
// `respawnOverridden` the tab paints in the accent. What does NOT come here is the editing: the edit icon
...
/** This window's accent — a warm amber, deliberately none of the four already in use (damage violet,
