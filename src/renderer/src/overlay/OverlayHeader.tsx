...
import { IconButton, ICON_ACCENT_VIOLET } from './IconButton'
...
export interface OverlayHeaderSelect {
  ...
  /** the owning overlay's accent color (damage violet / heal green). */
  accent: string
}
  ...
  return (
    <span
      ...
      style={{
        ...
        borderRadius: '50%',
        flexShrink: 0,
        background: live ? PALETTE.green : 'rgba(255,255,255,0.25)',
        boxShadow: live ? `0 0 5px ${PALETTE.green}` : 'none'
      }}
    />
  )
}
