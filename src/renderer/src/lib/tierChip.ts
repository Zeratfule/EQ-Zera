...
// color reads far better than white). Measured contrast (fg = PALETTE.ink #0b0f1a vs bg):
//   D0  bg #9aa0a6 (lightened from #7a7a7a so dark text clears 4.5) → 7.25
//   D1  bg PALETTE.green  #4ade80 → 10.98
//   D2  bg PALETTE.cyan   #38bdf8 → 8.93
//   D3  bg PALETTE.amber  #fbbf24 → 11.46
//   D4  bg PALETTE.accent #a78bfa → 7.03
// All comfortably pass WCAG AA (4.5) for normal text, and tests/palette.test.mts re-measures
// them on every run. Used by BossView (and any future tier-chip surface) so they stay consistent.
...
const TIER_FG = PALETTE.ink

export const TIER_STYLES: TierStyle[] = [
  { bg: '#9aa0a6', fg: TIER_FG, label: 'D0', long: 'D0 · base' },
  { bg: PALETTE.green, fg: TIER_FG, label: 'D1', long: 'D1 · Awakened' },
  { bg: PALETTE.cyan, fg: TIER_FG, label: 'D2', long: 'D2 · Adaptive' },
  { bg: PALETTE.amber, fg: TIER_FG, label: 'D3', long: 'D3 · Fused' },
  { bg: PALETTE.accent, fg: TIER_FG, label: 'D4', long: 'D4 · Refined' }
]
