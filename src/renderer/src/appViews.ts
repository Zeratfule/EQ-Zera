...
export type View =
  ...
  // your own observed counts and per-hour beside the wiki's list. It sits next to Quests because
  // both are reads of the same committed corpus, and it links into Loot and Mobs.
  | 'zoneloot'
  | 'build'
  | 'planner'
  ...
  | 'wishlist'
  // THE CRAFTING TAB (EQ Zera): the tradeskill helper - what the committed recipe corpus says you
  // can make from what your newest inventory dump says you hold, what you are one ingredient away
  // from, and for any recipe what is missing. It sits in the gear area because it is a fifth face
  // of the same question the other four ask: what should I be carrying, and why.
  | 'crafting'
  | 'buffs'
  | 'timers'
  | 'preferences'
...
export const VIEW_LABELS: Record<View, string> = {
  ...
  loot: 'Loot',
  quests: 'Quests',
  // Two words, as a player says it. The nav rail sets it uppercase itself.
  zoneloot: 'Zone Loot',
  // THE BUILD TAB (EQ Zera, 2026-09-06): the character builder in the gear area — what you wear,
  // what it adds up to for a tank / a DPS / a healer, and what to swap in.
  build: 'Build',
  ...
  wishlist: 'Wish list',
  // One word, as a player says it - and the day a recipe row deep-links into Loot, this is also
  // what that drill's Back button will read.
  crafting: 'Crafting',
  buffs: 'Buffs',
  timers: 'Timers',
...
export const GEAR_AREA_VIEWS: readonly View[] = (
  ...
  // Crafting is LAST, after Wish list: it is the only face that reads the recipe corpus rather
  // than the item one, and it is the one you open when the shopping questions already have answers.
  ['gear', 'build', 'planner', 'character', 'wishlist', 'crafting'] as const
