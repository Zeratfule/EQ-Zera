    ...
    >
      ...
      >
        ...
        <Link
          ...
          // THE SIZE IS STATED HERE BECAUSE THE HIERARCHY ABOVE DEPENDS ON IT (2026-09-08). The
          // 2026-09-06 theme put buttons on a compact display face (11px, 10px at `size="small"`)
          // and left `caption` where it was, at 12px body text - so the FOOTNOTE was rendering
          // BIGGER than the action beside it, which is the exact inversion of the second rule in
          // this file's header. Sizing the link rather than growing the button is deliberate: this
          // is a slim bar over the app's bottom edge, and a taller one starts covering what it
          // floats over.
          sx={{ fontSize: 10 }}
