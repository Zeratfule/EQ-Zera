...
// The quest-item pop-up's three preferences (ROADMAP §1) — a card of the celebration toast's, so
// it sits directly under it in this section.
import { QuestToastSetting } from './QuestToastSetting'
...
function overlaysSection(): PrefSection {
  return {
    ...
    items: [
      ...
      {
        id: 'quest-item-toast',
        label: 'Quest item pop-ups',
        keywords:
          'quest item items loot looted popup pop-up pop up card steps walkthrough turn-in turn in collect drop drops class classes repeat again overlay',
        content: <QuestToastSetting />
      },
      {
        id: 'alert-banner',
        label: 'Alert banner',
