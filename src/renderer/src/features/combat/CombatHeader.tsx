...
function StanceReadout({
  ...
  return (
    <>
      {stance.stance && <ModifierSlot slot={1} value={stance.stance} color={PALETTE.accent} />}
      {stance.invocation && <ModifierSlot slot={2} value={stance.invocation} color={PALETTE.amber} />}
