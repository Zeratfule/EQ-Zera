...
// like (it used to keep a private copy, which is how slay stayed melee-coloured here).
                ...
                return (
                  <g key={i}>
                    <rect
                      ...
                      height={PIN_H - 2}
                      rx={2}
                      fill={group === 'stance' ? withAlpha(PALETTE.accent, 0.35) : withAlpha(PALETTE.amber, 0.35)}
