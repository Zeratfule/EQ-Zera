  ...
  return (
    ...
    >
      ...
      <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap>
        ...
        {/* THE FIFTH CARD, AND THE ONE THAT EARNS ITS PLACE PER WINDOW (roadmap 2 item 11). It sits
            beside the pace card because it is the other half of the same question — how fast the
            bar moved, and what the camp paid while it did. It draws NOTHING when the log has no
            coin sentence in this window; see CoinTile.tsx for why absent beats a blank. */}
        <CoinTile stats={stats} />
      </Stack>
