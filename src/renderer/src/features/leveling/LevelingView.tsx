...
function AaOverTimePanel({
  ...
  return (
    <Paper variant="outlined" sx={{ p: 2 }}>
      ...
      <AreaChart points={drawn} color={PALETTE.cyan} chrome={chrome} />
    </Paper>
  )
}
...
function LevelOverTimePanel({
  ...
  return (
    <Paper variant="outlined" sx={{ p: 2 }}>
      ...
      <LevelStepChart segments={segments} curve={curve} color={PALETTE.accent} aaPoints={aaPoints} chrome={chrome} />
