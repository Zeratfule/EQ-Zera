 ...
 *     (`con:card-closed`) that never reaches any fold, and `engine/crates/zengine/src/concard.rs`
 ...
 * chips are NOT joined engine-side yet. `zengine/src/concard.rs` states why at length and it is not
