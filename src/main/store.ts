...
import { SEED_ALERTS, seedAlertsWith } from './alertSeeds'
...
const DEFAULT_OVERLAY_CONFIG: Record<OverlayKind, OverlayConfig> = {
  ...
  // THE FARM METER (roadmap 2 item 8) - kills, XP, drops and coin per hour since you zoned in.
  // Default off, no migration: the fifth restatement of the policy above, and `overlays.farm` has
