...
| Field | Values | What it means |
| --- | --- | --- |
| `kind` | `fight` · `overall` · `heal-fight` · `heal-overall` · `events` · `toast` · `buffs` · `debuffs` · `xp` · `respawn` · `farm` · `alertBanner` · `conCard` | Which overlay. |
...
| `overlaysEnabled` | list of `fight` · `overall` · `heal-fight` · `heal-overall` · `events` · `toast` · `buffs` · `debuffs` · `xp` · `respawn` · `farm` · `alertBanner` · `conCard` | Which floating meters are open. |
