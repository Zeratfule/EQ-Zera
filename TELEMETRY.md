...
EQ Zera can send anonymous usage counts so the person building it can see
...
**This build does not send.** EQ Zera compiles in no ingest address, so the counts on this
page are kept locally (Preferences shows them as JSON) and never leave your machine. The
consent gates are unchanged for the day that changes: nothing is
...
| Field | Values | What it means |
| --- | --- | --- |
| `view` | `overview` · `combat` · `mobs` · `maps` · `bosses` · `posky` · `alerts` · `leveling` · `loot` · `quests` · `zoneloot` · `build` · `planner` · `buffs` · `timers` · `gear` · `wishlist` · `character` · `crafting` · `preferences` · `triage` | Which tab. A fixed list of tab names. |
...
| Field | Values | What it means |
| --- | --- | --- |
| `kind` | `fight` · `overall` · `heal-fight` · `heal-overall` · `events` · `toast` · `buffs` · `debuffs` · `xp` · `respawn` · `farm` · `run` · `alertBanner` · `conCard` | Which overlay. |
...
| `overlaysEnabled` | list of `fight` · `overall` · `heal-fight` · `heal-overall` · `events` · `toast` · `buffs` · `debuffs` · `xp` · `respawn` · `farm` · `run` · `alertBanner` · `conCard` | Which floating meters are open. |
...
| `view` | `overview` · `combat` · `mobs` · `maps` · `bosses` · `posky` · `alerts` · `leveling` · `loot` · `quests` · `zoneloot` · `build` · `planner` · `buffs` · `timers` · `gear` · `wishlist` · `character` · `crafting` · `preferences` · `triage` · `unknown` | Which tab was open. A fixed list. |
